...
public class Tower extends Destructible implements GameConstants, EntityConstants {
    ...
    public Tower(int teamSide, int type, int evolution, BufferedImage[] towerSprites, BufferedImage[] turretSprites, BufferedImage[] projectileSprites) {
    ...
    public void addTurret(int turretSpot){
        this.turrets.set(turretSpot, new Turret(getTeamSide(), turretSpot, getEvolution(), turretSprites[this.getEvolution()], projectileSprites[this.getEvolution()]));
    }
